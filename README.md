...
## What I have learned:
  1. How to create an Elastic Container Resgistry on AWS and how does it works
  2. How to create credentials and access the ECR registry via Jenkins.
  3. How to Deploy application on EKS cluster via Jenkins
